...
public sealed class BuildCapabilityGrantMatrixTests
{
    ...
    {
        var service = CreateService("BUILD-TEAM", [new BuildModule(), new BuildTeamModule()]);
    ...
    {
        var service = CreateService("BUILD-TEAM", [new BuildModule()]);
        Assert.False(service.Has(OrganisationId, capability));
    }
