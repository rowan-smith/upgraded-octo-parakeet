namespace ForgeDeck.Git.Domain;
...
public sealed class GitRepository
{
    ...
    public GitCommit ReceivePush(string branchName, string message, string author)
    {
        ...
        {
            Branches[Branches.IndexOf(branch)] = branch with { HeadSha = sha };
        }
        else
        {
            Branches.Add(new GitBranch(branchName, sha, branchName == DefaultBranch));
        }
